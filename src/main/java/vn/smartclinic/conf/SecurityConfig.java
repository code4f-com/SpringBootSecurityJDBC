...
import vn.smartclinic.config.auth.JwtAuthFilter;
import vn.smartclinic.service.UserDetailsServiceImpl;
...
//            our public endpoints
            .requestMatchers(HttpMethod.POST, "/api/auth/signup/**").permitAll() // Cho phép tất cả
